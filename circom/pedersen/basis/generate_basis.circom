...
template generate_basis(){
    ...
    for (var i5=0;i5<50;i5++){
        ...
        adders5[i5].in2[0]<==basis2[i5][0];
        adders5[i5].in2[1]<==basis2[i5][1];
    ...
    for (var i6=0;i6<50;i6++){
        ...
        adders6[i6].in2[0]<==basis2[i6][0];
        adders6[i6].in2[1]<==basis2[i6][1];
    ...
    for (var i7=0;i7<50;i7++){
        ...
        adders7[i7].in2[0]<==basis2[i7][0];
        adders7[i7].in2[1]<==basis2[i7][1];
